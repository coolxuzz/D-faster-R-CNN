...
class AnchorsGenerator(nn.Module):
    ...
    def __init__(self, sizes=(128, 256, 512), aspect_ratios=(0.5, 1.0, 2.0)):
        ...
        # sizes = ((6,), (12,), (48,), (96,), (192,))
        # spect_ratios = ((0.5, 1.0, 2.0),) * len(sizes)
        self.sizes = sizes
...
class RPNHead(nn.Module):
    ...
    def __init__(self, in_channels, num_anchors):
        ...
        # 3x3 滑动窗口
        self.conv = nn.Conv2d(in_channels*2, in_channels, kernel_size=3, stride=1, padding=1)
...
#             print(pro['{}'.format(i)].shape)
            t = F.relu(self.conv(feature))
#             t2 = self.conv2(pro['{}'.format(i)])
#             t2 = F.relu(t2)
