...
from . import feature_pyramid_network
...
def resnet50_fpn_backbone(pretrain_path="",
    ...
    out_channels = 256
    return feature_pyramid_network.BackboneWithFPN(resnet_backbone, return_layers, in_channels_list, out_channels, extra_blocks=extra_blocks)
